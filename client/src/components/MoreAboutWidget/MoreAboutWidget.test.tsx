...
describe('MoreAboutWidget', () => {
    it('корректное отображение данных', () => {
        ...
        expect(screen.getByText(moreAboutWidgetMock.fromDescription)).toBeInTheDocument;

        expect(screen.getByText(moreAboutWidgetMock.toDescription)).toBeInTheDocument;
    })
})